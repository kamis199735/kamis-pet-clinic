package kamis199735.springframework.kamispetclinic.bootstrap;

import kamis199735.springframework.kamispetclinic.model.*;
...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        psychology.setDescription("Psychology");
        Speciality savedPsychology = specialtyService.save(psychology);
        ...
        vet1.getSpecialities().add(savedPsychology);
